  ...
  <div class="asset">
    ...
    <div class="section">
      <ul>
        ...
        <li>Learning goals should be specific, and you must be able to test students to see if they actually accomplished the learning goals.</li>
      </ul>
    </div>
    <h3>Lectures</h3>
    <div class="section">
    ...
    <div class="section">
      <h3>Project</h3>
      <ul>
        <li>Create a lesson plan for one of the lesson you are going to teach. Be sure to save it in the correct google drive <a href="https://drive.google.com/open?id=0B7QNCc2N_umjem5EakJLeUNSOVU">folder</a>.</li>
        <li>Here is a link to the <a href="https://docs.google.com/document/d/1qX5-ShB3WdDoV4g46RKGV-LZQkHlZzJKOxz08wy99ZM/edit?usp=sharing">template</a> you should use.</li>
  ...
  <div class="asset">
    ...
    <div class="section">
      <ul>
        ...
        <h4>Austin</h4>
        <ul>
          <li><a href="https://web.austincodingacademy.com/">Intro</a></li>
          <li><a href="https://javascript.austincodingacademy.com/">Intermediate</a></li>
          <li><a href="https://fullstack.austincodingacademy.com/">Advanced</a></li>
        </ul>
        <h4>San Antonio, Houston, Dallas</h4>
        <ul>
          <li><a href="https://ciw.austincodingacademy.com/">Intro</a></li>
          <li><a href="https://csharp.austincodingacademy.com/">Intermediate</a></li>
